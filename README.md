...
![PLC](https://img.shields.io/badge/PLC-Automation-orange?style=flat)
![Siemens](https://img.shields.io/badge/Siemens-TIA%20Portal-009999?style=flat\&logo=siemens\&logoColor=white)
...
### 🏭 Automated Pallet Sorting — Unilever Engineers League 2026

Concept for automating pallet inspection and sorting in an industrial mezzanine area using:

* AI-based pallet inspection
* Robotic handling
* Conveyor systems
* AGV integration
* Automated pallet classification and sorting

**Result:** 🥇 1st Place — Unilever Engineers League 2026

---

### 🌱 Automated Hydroponic Farming System

An automated hydroponic system designed for controlled strawberry cultivation.

**Technologies:** Sensors • Embedded Systems • C/C++ • Automation

---

### 👓 AI-Based Assistive Smart Glasses

Assistive smart-glasses concept combining:

* Object detection
* Text recognition
* Ultrasonic obstacle detection

Designed to improve environmental awareness and mobility for visually impaired users.
